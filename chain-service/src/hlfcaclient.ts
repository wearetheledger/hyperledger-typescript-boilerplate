...
//         this.hlfConfig.options.caName,
//         cryptoSuite,
//       );
//     }
//     // create admin
//     return this.createAdmin(
//       adminCreds.enrollmentID,
//       adminCreds.enrollmentSecret,
//       adminCreds.MspID,
//     );
//   }
...
//         } else {
//           return this.enrollUser(enrollmentID, enrollmentSecret, mspid).then(
//             (user: User) => {
//               this.hlfConfig.adminUser = user;
//               return this.hlfConfig.client.setUserContext(
...
//       return this.hlfConfig.caClient
//         .register(
//           {
...
//     return (this.hlfConfig.client.getUserContext(
//       userId,
//       checkPersistence,
//     ) as Promise<User>).then(userFromStore => {
